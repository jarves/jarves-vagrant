...
debconf-set-selections <<< 'mysql-server-5.5 mysql-server/root_password password kryn'
debconf-set-selections <<< 'mysql-server-5.5 mysql-server/root_password_again password kryn'
